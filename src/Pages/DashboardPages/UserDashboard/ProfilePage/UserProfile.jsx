...
const UserProfile = () => {
    ...
    return (
        <div className={`p-4 lg:p-10 bg-white ${isEdit ? 'profile_update' : 'profile'}`}>
            ...
            <div className="border border-slate-200 p-3 md:px-10 md:py-5 mt-6 rounded-lg overflow-hidden">
                <div className="flex items-center justify-between">
                    <h3 className="capitalize text-lg md:text-xl font-second">Personal Information</h3>
